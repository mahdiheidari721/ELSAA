...
EXPERIMENTS = [
    #dict(method="elsaa",        batch_size=8,  grad_accum_steps=4),
    #dict(method="elsaa_lambda", batch_size=2,  grad_accum_steps=8),
    dict(method="causal_sparse",batch_size=4,  grad_accum_steps=4),
    #dict(method="causal_race",  batch_size=16,  grad_accum_steps=2),
    #dict(method="exact",        batch_size=16,  grad_accum_steps=2),
